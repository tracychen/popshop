...
import {ERC20DiscountStrategy} from "./ERC20DiscountStrategy.sol";

/// @dev Discount strategy that gives a discount based on the ERC20 min token balance of the buyer
contract MinERC20DiscountStrategy is ERC20DiscountStrategy {
    ...
    constructor(address shopAddress, address tokenAddress, uint256 _bps, uint256 _minBalance)
        ERC20DiscountStrategy(shopAddress, tokenAddress)
    {
